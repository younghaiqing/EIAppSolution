...
namespace EIAppeEmail
{
    class Program
    {
        static void Main(string[] args)
        {
            GetEmails();
            NewMethod();
           // S22.Pop3.Pop3Client client = new S22.Pop3.Pop3Client("pop3.163.com", 110, "wangwending513@163.com", "wu515632356?");
           //var t= client.GetMessage(1);  
        ...
        {
            //需要首先设置这些信息
            string pop3Server = "pop3.163.com";    //邮箱服务器 如："pop.sina.com.cn";或 "pop.tom.com" 好像sina的比较快
            int pop3Port = 110;          //端口号码   用"110"好使。最好看一下你的邮箱服务器用的是什么端口号
            bool pop3UseSsl = false;
            string username = "wangwending513@163.com";        //你的邮箱用户名
            string password = "wu515632356?";      //你的邮箱密码
